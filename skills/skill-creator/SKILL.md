...
**CRITICAL: Before writing SKILL.md content, read `references/skill-patterns.md` and apply the patterns checklist.** The patterns reference contains 10 proven patterns (Q&A Gate, Derived Decisions, Strong Opinions, Domain Methodology, Anti-Patterns, Technical Specs, Reference Benchmarks, Architecture Blueprints, Output Constraints, Variation Rules) that separate great skills from mediocre ones. Walk through each pattern and decide which ones apply to the skill being created.
...
Then apply the skill-patterns checklist:
- [ ] Q&A Gate: What must be known before starting?
- [ ] Derived Decisions: What should Claude decide without asking?
- [ ] Strong Opinions: What principles override generic defaults?
- [ ] Domain Methodology: What framework do experts use?
- [ ] Anti-Patterns: What are the common failure modes?
- [ ] Technical Specs: What exact values took effort to discover?
- [ ] Reference Benchmarks: What does "good" look like?
- [ ] Architecture Blueprint: What's the exact output structure?
- [ ] Output Constraints: What limits prevent over-engineering?
- [ ] Variation Rules: How should repeated items differ?
